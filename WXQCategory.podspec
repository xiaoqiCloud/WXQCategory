#
# Be sure to run `pod lib lint WXQCategory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'WXQCategory'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WXQCategory.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'xiaoqiCloud' => '33372090+xiaoqiCloud@users.noreply.github.com' }
